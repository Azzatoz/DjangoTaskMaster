...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('owner', 'Владелец'), ('moderator', 'Модератор'), ('executor', 'Исполнитель')], default='executor', max_length=10)),
        ...
        migrations.AddField(
            model_name='project',
            name='users',
            field=models.ManyToManyField(through='tasks.ProjectRole', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='Task',
            fields=[
